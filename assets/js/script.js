$(document).ready(function () {
  ...
  $("#aside-color li").click(function () {
    ...
    $(
      ".theme-back-color-item, .theme-back-solid-color-item, .theme-color-item, .theme-border-color-item "
    ).attr("data-color", colorTheme);
  ...
  if (localStorage.getItem("colorTheme") != null) {
    $(
      ".theme-back-color-item, .theme-back-solid-color-item, .theme-color-item, .theme-border-color-item"
    ).attr("data-color", localStorageTheme);
  } else {
    $(
      ".theme-back-color-item, .theme-back-solid-color-item, .theme-color-item, .theme-border-color-item"
    ).attr("data-color", "blue-color");
  }

  $(".dach-min-box .tab_box ul li").click(function () {
  ...
  $(document).click(function () {
    $(".nav-section .nav-box .nav-item .click-box ")
      .siblings(".nav-sub-box")
      .hide();
  ...
  const pageTitle = $(
    ".aside-box .aside-ul ul li a.active .ul-text , .nav-section .nav-box .nav-item .nav-sub-box ul.user-ul li a.active"
  ).text();
